...
@Component({
  selector: 'app-video-assets',
  templateUrl: './video-assets.component.html',
  styleUrls: ['./video-assets.component.scss']
})
export class VideoAssetsComponent implements OnInit {
  assets: Asset[];
  ...
  ngOnInit() {
    this.assetService
      .getUserVideos(this.authService.decodedToken.nameid)
      .subscribe(result => {
